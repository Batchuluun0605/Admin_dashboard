...
const ShortCuts = () => {
  return (
    <div className="flex gap-4 flex-col bg-white rounded-lg py-8 px-4 dark:bg-gray-600">
      ...
      {shortcutLink.map((list, index) => (
        ...
        >
          <div className="flex gap-4 items-center">
            <span className="bg-blue-100 p-2 rounded-full h-8 w-8 flex items-center justify-center dark:bg-gray-800 dark:text-gray-300">
              <list.icon />
            </span>
